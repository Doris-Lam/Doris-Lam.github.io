        ...
        <div className="flex items-center justify-center space-x-2">
            ...
            <div className="space-y-3 text-left max-w-lg mx-auto">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-stone-700 dark:text-stone-200 text-sm leading-relaxed">
                  Built{" "}
                  <a href="https://github.com/Doris-Lam/Snout" target="_blank" rel="noopener noreferrer" className="text-stone-900 font-medium hover:underline dark:hover:underline dark:decoration-stone-400 underline-offset-2 decoration-2">
                    <span className="dark:text-stone-100">
                    🐶 Snout,
                    </span>
                  </a>{" "}
                  a Go-based French interpreter with built-in REPL, and custom parser error handling
                </p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-stone-700 dark:text-stone-200 text-sm leading-relaxed">
                  ...
                  <a href="https://devpost.com/software/signspeak-kgufm1" target="_blank" rel="noopener noreferrer" className="text-stone-900 font-medium hover:underline dark:hover:underline dark:decoration-stone-400 underline-offset-2 decoration-2">
                    <span className="dark:text-stone-100">
          ...
          <div className="pt-6 space-y-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-stone-700 dark:text-stone-200">
                💻 Check out{" "}
                <a href="/projects" className="text-stone-900 font-medium hover:underline dark:hover:underline dark:decoration-stone-400 underline-offset-2 decoration-2">
                  <span className="dark:text-stone-100">
                  what I've built
                  </span>
                </a>
